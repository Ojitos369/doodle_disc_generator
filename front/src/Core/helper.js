...
export const pages = [
    {name: 'Editor', menu_name: 'herramientas', elements: [
        {name: 'Editor Circular', page_name: 'editor', to: '/', menuBarMode: 'menuBarDefault'},
    ]},
    {name: 'Index', menu_name: 'index', elements: [
        {name: 'Index', page_name: 'index', to: '/index', menuBarMode: 'menuBarDefault'},
    ]},
